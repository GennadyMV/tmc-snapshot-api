...
public class SnapshotControllerTest {
    ...
    public void shouldReturnSnapshots() throws Exception {
        ...
        when(tmcDataService.findUsername("", 2064)).thenReturn("smith");
    ...
    public void shouldReturnSnapshot() throws Exception {
        ...
        when(tmcDataService.findUsername("", 2064)).thenReturn("jones");
        ...
        assertEquals("public class HeiMaailma { }", snapshot.getFiles().get(0).getContent());
    }
    ...
    public void shouldReturnNullOnFalseSnapshotId() throws Exception {
        ...
        when(tmcDataService.findUsername("", 1)).thenReturn("smith");
