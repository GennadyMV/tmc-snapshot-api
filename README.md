...
[![Build Status](https://travis-ci.org/rage/tmc-snapshot-api.svg?branch=master)](https://travis-ci.org/rage/tmc-snapshot-api/)
[![Coverage Status](https://img.shields.io/coveralls/rage/tmc-snapshot-api.svg)](https://coveralls.io/r/rage/tmc-snapshot-api/)

A Spring Boot Web API for accessing TMC exercise snapshots (Java 7 + Java EE 7 + Spring Boot 1.1.7.RELEASE) from the [tmc-spyware-server](https://github.com/testmycode/tmc-spyware-server/).
